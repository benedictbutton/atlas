          ...
          <div className="p-4 py-16 flex flex-col justify-center bg-blueGray-100 h-full">
            ...
            >
              ...
              <label className="block mb-5">
                ...
                <input
                  className="px-4 py-3.5 w-full text-white font-medium placeholder-gray-400 bg-white outline-none border border-gray-300 rounded-lg focus:ring focus:ring-indigo-300"
                  type="password"
                  placeholder="********"
                  name="password"
